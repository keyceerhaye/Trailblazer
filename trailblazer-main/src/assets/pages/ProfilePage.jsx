        ...
        <div className="sidebar-top">
          <div className="sidebar-brand">
            ...
            <div className="pf-brand-info">
              ...
              <span className="pf-brand-subtitle">PRINTING & LAYOUT SERVICES</span>
            </div>
          </div>

          <nav className="sidebar-nav">
            <ul>
              <li><a href="/dashboard"><LayoutDashboard className="icon" />Dashboard</a></li>
              <li className="active"><a href="#"><User className="icon" />Profile</a></li>
              <li><a href="orderhistory"><History className="icon" />Order History</a></li>
            </ul>
          </nav>
        </div>
      </aside>
          ...
          <div className="profile-card">
            <header className="profile-header">
              ...
              <div className="user-info">
                ...
                <p className="username">@{userData.firstName.toLowerCase()}_{userData.lastName.toLowerCase()}</p>
            ...
            <form onSubmit={handleSubmit} className="profile-form">
              <div className="form-grid">
                ...
                <div className="loc">
                  ...
                  <input type="text" id="location" name="location" value={userData.location} onChange={handleChange} />
                </div>
              </div>

  ...
  return (
    <div className="about-container">
      <section className="about-header">
        <img src={aboutHeaderImage} alt="Team Working Together" className="about-header-img" />
      ...
      <section className="about-mission">
        <img src={missionImage} alt="Students Collaborating" className="about-mission-img" />
        <div className="about-mission-text">
          <h2>Mission</h2>
          <p>
            Our mission is to provide affordable, high-quality, and reliable printing and layout services
            that empower USTP students to present their academic and creative work with excellence and
            confidence.
          </p>
        </div>
      </section>
      ...
      <section className="about-goals">
        <div className="about-goals-box">
          <h3>Our Goals</h3>
          <ul>
            <li>To support students with fast, helpful, friendly, and high-quality printing</li>
            <li>To uphold creativity and professionalism in graphic outputs through well-designed layouts</li>
            <li>To offer reliable customer service that understands and responds to the needs of fellow students</li>
          </ul>
        </div>
      </section>
      ...
      <section className="about-team">
        ...
        <p className="team-description">
          ...
          needs of our campus community with passion and purpose.
        </p>
      </section>
    </div>
  );

...
import { faEnvelopeOpenText, faLockOpen, faCircleCheck } from "@fortawesome/free-solid-svg-icons";
          ...
          {!isVerified ? (
            ...
            <>
              <div className="fp-password-container">
                ...
                <small className="fp-password-note">
                  Password must be 8+ characters: contains uppercase, lowercase, number
                </small>

                <div className="fp-submit-btn-container">
                  <button className="fp-submit-btn" onClick={handleSavePassword}>
                    Save
                  </button>
                </div>
              </div>
            ...
            <>
                <div className="updated-password-container">
                    ...
                    <p className="fp-description">Your password has been updated.</p>
                    <div className="fp-submit-btn-container">
                        <button

              ...
              <div className="delivery-step-circles">
                {steps.map((step, index) => (
                  <React.Fragment key={step.number}>
                    {index > 0 && (
                      <div className={`delivery-line ${steps[index - 1].active ? 'active' : ''}`}></div>
                    )}
                    <div className={`delivery-step-circle ${step.active ? "active" : ""}`}>
      ...
      <div className="delivery-options">
        ...
        >
          ...
          <div className="delivery-info">
            <h4>Pick-up</h4>
            <p>CEA Building<br />Ground Floor<br />10:00 AM</p>
            <p><em>Note: Get your print in <strong>7 minutes</strong></em></p>
          </div>
        </div>

        <div
          className={`delivery-option ${selectedOption === "deliver" ? "selected" : ""}`}
        ...
        >
          ...
          <div className="delivery-info">
            <h4>Deliver</h4>
            <em>If you choose deliver please enter your delivery address in the next step.<br />
              Delivery Fee <strong>depends</strong> on what building.<br />

    ...
    <div className="terms-container">
      ...
      {activeTab === "terms" && (
        <>
          ...
          <p className="text">
            “We,” “Us,” and “Our” refer to CPE 2D Students, the operator of this website.<br />
          ...
          <p className="text">
            ...
            Estimated pick-up time is subject to the admin’s availability, and the final schedule
            will be determined and confirmed by the admin.
          </p>

          <h2 className="section-header">Refunds and Cancellations</h2>
          <p className="text">
            Orders can only be canceled before production starts.<br />
            Refunds are only available for defective or incorrect products due to our fault.<br />
            Custom products are non-refundable unless there is a manufacturing defect.
          </p>

          <h2 className="section-header">Intellectual Property</h2>
          <p className="text">
            All designs created by us remain our property unless otherwise agreed.<br />
            Customers confirm they have the right to use any uploaded content and do not
          ...
          <p className="text">
            ...
            Maximum liability shall not exceed the amount paid for the specific order.
          </p>
          ...
          <p className="text">
            ...
            us at <strong>supporttpl@gmail.com</strong> or call us at <strong>+63-9483795069</strong>.
          </p>
        </>
      )}
      ...
      {activeTab === "privacy" && (
        <>
          ...
          <p className="text">
            Trailblazers Printing and Layout Services respects your privacy and is committed to
          ...
          <p className="text">
            Personal Information: Name, email, phone number, delivery address, and payment details.<br />
            Order Information: Details about your orders, preferences, and transaction history.<br />
            Technical Data: IP address, browser type, and cookies for website functionality.
          </p>

          <h2 className="section-header">How We Use Your Information</h2>
          <p className="text">
            - To process and fulfill orders.<br />
            - To communicate with you about your orders and updates.<br />
            - To improve our services and website functionality.<br />
          ...
          <p className="text">
            ...
            - We may share data with third-party service providers (e.g., payment processors, shipping companies) for order fulfillment.<br />
            - We may disclose information if required by law or to protect our rights.
          </p>

          <h2 className="section-header">Cookies and Tracking Technologies</h2>
          <p className="text">
            - We use cookies to enhance user experience and track website usage.<br />
          ...
          <p className="text">
            We implement security measures to protect your data from unauthorized access or breaches.<br />
          ...
          <p className="text">
            ...
            - Contact us at <strong>supporttpl@gmail.com</strong> for any privacy-related concerns.
          </p>

          <h2 className="section-header">Changes to this Policy</h2>
          <p className="text">
            We may update this policy from time to time.<br />
            Continued use of our website after updates implies acceptance of the revised policy.
          </p>

          <h2 className="section-header">Contact Information</h2>
          <p className="text">
            For any questions regarding this Privacy Policy, contact us at <strong>supporttpl@gmail.com</strong> or call us at <strong>+63-9483795069</strong>.
          </p>
        </>
      )}
    </div>

...
import orderIcon from "../pages/img/bag.png";
import pendingIcon from "../pages/img/pending.png";
import completedIcon from "../pages/img/complete.png";
...
const AdminDashboard = () => {
  ...
  const navItems = [
    ...
    { title: "Sales", icon: salesChartImage, path: "/admin-sales" }, // Path updated here
  ];
      ...
      <div className="ad-content-wrapper">
        <div className="ad-topbar">
          ...
          <div className="ad-user-profile" onClick={toggleDropdown}>
            ...
            <div
              className={`ad-dropdown-arrow ${isDropdownOpen ? "rotate" : ""}`}
            >
              v
            </div>
            {isDropdownOpen && (
              <div className="ad-dropdown-menu">
                <ul>
                  <li onClick={handleProfileClick}>
                    <User size={25} className="ad-dropdown-icon" /> Admin
                    Profile
                  </li>
        ...
        <div className="ad-main-content">
                ...
                {orders.map((order, index) => (
                  ...
                  >
                    ...
                    <td>
                      <span
                        className={`ad-status ${
                          order.status === "Ready" ? "ready" : "ontheway"
                        }`}
                      >
                        {order.status}
                      </span>
          ...
          {selectedOrderIndex !== null && (
            ...
            >
              <div
                onClick={() => alert(`Cancel ${orders[selectedOrderIndex].id}`)}
              >
                Cancel
              </div>
              <div
                onClick={() =>
                  alert(`Cancel product from ${orders[selectedOrderIndex].id}`)
                }
              >
                Cancel Product
              </div>
              <div
                onClick={() =>
                  alert(`Message ${orders[selectedOrderIndex].name}`)
                }
              >
                Message
              </div>

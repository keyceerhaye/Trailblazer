    ...
    <div className="bs-wrapper">
      ...
      <div className="bs-main">
        ...
        <div className="bs-card bs-summary-card">
          <div className="bs-summary-info">
            <p>
              <strong></strong> {orderDetails.paperSize} Bondpaper
            </p>
            <p>
              <strong></strong> {orderDetails.printOption}
            </p>
            <p>
              <strong></strong> {orderDetails.turnaroundTime}
            </p>
            <p>
              <strong></strong> {orderDetails.paymentMethod}
            </p>
          </div>
      ...
      <div className="bs-footer">
        ...
        <div className="bs-footer-right">
          ...
          <button className="bs-next-btn" onClick={handleNextClick}>
            Next
          </button>
        </div>
      </div>
